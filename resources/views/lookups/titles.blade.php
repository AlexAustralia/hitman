...
@section('title') Titles | @parent @stop
...
@section('page-name') Titles @stop
@section('page-description') Edit Lookup: Titles @stop
@section('breadcrumb')
    <li>
...
@section('content')
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-puzzle-piece"></i> Titles </div>
        </div>
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group">
                            <button id="titles_new" class="btn green"> Add New
            ...
            <table class="table table-striped table-hover table-bordered" id="titles">
                <thead>
                <tr>
                    <th> Title </th>
                    <th> Edit </th>
...
@section('page-level-scripts')
    <script src="{{ asset('theme/pages/scripts/titles-datatables-editable.js') }}" type="text/javascript"></script>
