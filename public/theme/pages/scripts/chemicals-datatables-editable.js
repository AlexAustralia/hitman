    ...
    var handleTable = function () {
        ...
        function saveRow(oTable, nRow) {
            ...
            ajax = $.ajax({
                ...
                type: 'POST',
                url: '/edit-lookups/chemicals/save',
                dataType: 'json',
                encode: true,
                data: {
                    index: index,
                ...
                .done(function(response) {
                    ...
                    if (response == 'OK') {
                        ...
                        $('#error_ajax').find('p').html('This Chemical is already used! Be careful');
        ...
        var tableWrapper = $("#chemicals_wrapper");

        var nEditing = null;
        var nNew = false;

        $('#chemicals_new').click(function (e) {
            e.preventDefault();
        ...
        table.on('click', '.delete', function (e) {
            ...
            ajax = $.ajax({
                headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') },
                type: 'POST',
                url: '/edit-lookups/chemicals/delete',
                dataType: 'json',
                encode: true,
                data: {
                    index: index
