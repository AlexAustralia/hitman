    ...
    var handleTable = function () {
        ...
        function saveRow(oTable, nRow) {
            ...
            ajax = $.ajax({
                ...
                type: 'POST',
                url: '/edit-lookups/suburbs/save',
                dataType: 'json',
                encode: true,
                data: {
                    index: index,
                    locality: jqInputs[0].value,
                    postcode: jqInputs[1].value
                }
            })
                .done(function(response) {
                    ...
                    if (response == 'OK') {
                        ...
                        oTable.fnUpdate('<a class="delete" href="" data-toggle="confirmation" data-singleton="true">Delete</a>', nRow, 3, false);
                        oTable.fnDraw();
                        ...
                        $('#error_ajax').find('p').html('This Postcode is already used! Be careful');
        ...
        var tableWrapper = $("#suburbs_wrapper");

        var nEditing = null;
        var nNew = false;

        $('#suburbs_new').click(function (e) {
            e.preventDefault();
        ...
        table.on('click', '.delete', function (e) {
            ...
            ajax = $.ajax({
                headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') },
                type: 'POST',
                url: '/edit-lookups/suburbs/delete',
                dataType: 'json',
                encode: true,
                data: {
                    index: index
