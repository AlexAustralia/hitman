    ...
    var handleTable = function () {
        ...
        function saveRow(oTable, nRow) {
            ...
            ajax = $.ajax({
                ...
                type: 'POST',
                url: '/edit-lookups/technician-types/save',
                dataType: 'json',
                encode: true,
                data: {
                    index: index,
                ...
                .done(function(response) {
                    ...
                    if (response == 'OK') {
                        ...
                        $('#error_ajax').find('p').html('This Technician Type is already used! Be careful');
        ...
        var tableWrapper = $("#technician_types_wrapper");

        var nEditing = null;
        var nNew = false;

        $('#technician_types_new').click(function (e) {
            e.preventDefault();
        ...
        table.on('click', '.delete', function (e) {
            ...
            ajax = $.ajax({
                headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') },
                type: 'POST',
                url: '/edit-lookups/technician-types/delete',
                dataType: 'json',
                encode: true,
                data: {
                    index: index
