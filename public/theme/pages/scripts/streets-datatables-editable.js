    ...
    var handleTable = function () {
            ...
            ajax = $.ajax({
                ...
                .done(function(response) {
                    ...
                    if (response == 'OK') {
                        ...
                        $('#error_ajax').find('p').html('This Section is already used! Be careful');
        ...
        function loadStreets(oTable) {
            ...
            ajax = $.ajax({
                headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') },
                type: 'POST',
                url: '/edit-lookups/streets/upload',
                dataType: 'json',
                encode: true,
                data: {
                    suburb: suburb
                ...
                .error(function() {
                    App.unblockUI(el);
                    $('#error_ajax').find('p').html('Cannot load Streets!<br>Some errors occurred while getting data from the server!');
                    $('#error_ajax').modal('show');
                });
        ...
        var tableWrapper = $("#streets_wrapper");
        ...
        $('.select2me').on('change', function () {
            if($(this).val() != null) loadStreets(oTable);
        });

        $('#streets_new').click(function (e) {
            e.preventDefault();
        ...
        table.on('click', '.delete', function (e) {
            ...
            ajax = $.ajax({
                headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') },
                type: 'POST',
                url: '/edit-lookups/streets/delete',
                dataType: 'json',
                encode: true,
                data: {
                    index: index,
