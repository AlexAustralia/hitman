    ...
    var handleTable = function () {
        ...
        function saveRow(oTable, nRow) {
            ...
            ajax = $.ajax({
                ...
                type: 'POST',
                url: '/edit-lookups/standard-jobs/save',
                dataType: 'json',
                encode: true,
                data: {
                    index: index,
                ...
                .done(function(response) {
                    ...
                    if (response == 'OK') {
                        ...
                        oTable.fnUpdate('<a class="delete" href="" data-toggle="confirmation" data-singleton="true">Delete</a>', nRow, 5, false);
                        oTable.fnDraw();
                        ...
                        $('#error_ajax').find('p').html('This Acronym is already used! Be careful');
        ...
        var tableWrapper = $("#standard_jobs_wrapper");

        var nEditing = null;
        var nNew = false;

        $('#standard_jobs_new').click(function (e) {
            e.preventDefault();
        ...
        table.on('click', '.delete', function (e) {
            ...
            ajax = $.ajax({
                headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') },
                type: 'POST',
                url: '/edit-lookups/standard-jobs/delete',
                dataType: 'json',
                encode: true,
                data: {
                    index: index
