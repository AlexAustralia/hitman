    ...
    var handleTable = function () {
        ...
        function saveRow(oTable, nRow) {
            ...
            ajax = $.ajax({
                ...
                type: 'POST',
                url: '/edit-lookups/licence-description/save',
                dataType: 'json',
                encode: true,
                data: {
                    index: index,
                ...
                .done(function(response) {
                    ...
                    if (response == 'OK') {
                        ...
                        $('#error_ajax').find('p').html('This Licence Description is already used! Be careful');
        ...
        var table = $('#licence_descriptions');
        ...
        var tableWrapper = $("#licence_descriptions_wrapper");

        var nEditing = null;
        var nNew = false;

        $('#licence_descriptions_new').click(function (e) {
            e.preventDefault();
        ...
        table.on('click', '.delete', function (e) {
            ...
            ajax = $.ajax({
                headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') },
                type: 'POST',
                url: '/edit-lookups/licence-description/delete',
                dataType: 'json',
                encode: true,
                data: {
                    index: index
