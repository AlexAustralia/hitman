var TableDatatablesEditable = function () {
    ...
    var handleTable = function () {
            ...
            ajax = $.ajax({
                ...
                .done(function(response) {
                    ...
                    if (response == 'OK') {
                        ...
                        $('#error_ajax').find('p').html('This Title is already used! Be careful');
        ...
        var tableWrapper = $("#titles_wrapper");

        var nEditing = null;
        var nNew = false;

        $('#titles_new').click(function (e) {
            e.preventDefault();
        ...
        table.on('click', '.delete', function (e) {
            ...
            ajax = $.ajax({
                headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') },
                type: 'POST',
                url: '/edit-lookups/titles/delete',
                dataType: 'json',
                encode: true,
                data: {
                    index: index
